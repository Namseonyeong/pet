...
public class MemberControlloer {
	...
	// 회원정보 수정 (추가할것)
	@PostMapping("/Update")
	public String updateMember(Member member, Model model, MultipartFile file, MultipartFile file1, Principal principal) throws Exception {
	      
		memberService.updateMember(member, file, file1, principal);
   ...
   public String passwordEdit(Model model, Member member, @RequestParam("newPw") String newPw,
      ...
      model.addAttribute("searchUrl", "/PwChange");
