/**
 * @description 저장하기 전 데이터 입력 체크 함수
 * @author nsy
 */
...
//     document.getElementById("detail_form").action = "worker_product_list?pageNum= " + pageNum + "&rowsPerPage= " + rowsPerPage;
//     document.getElementById("detail_form").submit();
// }